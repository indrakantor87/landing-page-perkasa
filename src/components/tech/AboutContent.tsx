      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          ...
          >
            ...
            <p className="text-white font-medium drop-shadow-sm">{section.foundedLabel}</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-white font-medium drop-shadow-sm">{section.customersLabel}</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-4xl font-bold text-white mb-2 drop-shadow-md">{section.legalStatusTitle}</h3>
            <p className="text-white font-medium drop-shadow-sm">{section.legalStatusDescription}</p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20">
          ...
          >
            <h2 className="text-3xl font-bold text-white mb-6 border-l-4 border-perkasa-red pl-4 drop-shadow-md">{section.visionMissionTitle}</h2>
            <div className="mb-8">
              <h3 className="text-xl font-bold text-white mb-3 drop-shadow-sm">{section.visionTitle}</h3>
              <p className="text-white leading-relaxed font-medium drop-shadow-sm">{content.company.vision}</p>
            </div>
            <div>
              <h3 className="text-xl font-bold text-white mb-3 drop-shadow-sm">{section.missionTitle}</h3>
          ...
          >
            <h2 className="text-2xl font-bold text-white mb-6 drop-shadow-md">{section.legalTitle}</h2>
        ...
        >
          <h2 className="text-3xl font-bold text-center text-white mb-12 drop-shadow-md">{section.contactTitle}</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-2xl bg-black/40 border border-white/10 backdrop-blur-sm hover:border-[#00B4D8]/50 transition-colors shadow-lg">
              ...
              <h3 className="font-bold text-white mb-2 text-lg drop-shadow-sm">{section.addressTitle}</h3>
            ...
            <div className="text-center p-6 rounded-2xl bg-black/40 border border-white/10 backdrop-blur-sm hover:border-[#00B4D8]/50 transition-colors shadow-lg">
              ...
              <h3 className="font-bold text-white mb-2 text-lg drop-shadow-sm">{section.phoneTitle}</h3>
            ...
            <div className="text-center p-6 rounded-2xl bg-black/40 border border-white/10 backdrop-blur-sm hover:border-[#00B4D8]/50 transition-colors shadow-lg">
              ...
              <h3 className="font-bold text-white mb-2 text-lg drop-shadow-sm">{section.emailTitle}</h3>

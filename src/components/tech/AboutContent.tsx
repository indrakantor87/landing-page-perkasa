      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          ...
          >
            ...
            <p className="text-gray-200 font-medium">Tahun Berdiri</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-200 font-medium">Pelanggan Aktif</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-200 font-medium">Berizin Kominfo</p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20">
          ...
          >
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-200 leading-relaxed font-medium drop-shadow-sm">{siteConfig.company.vision}</p>
            </div>
            <div>
              <h3 className="text-xl font-bold text-white mb-3 drop-shadow-sm">Misi</h3>
              <ul className="space-y-3">
                {siteConfig.company.mission.map((item, index) => (
                  <li key={index} className="flex items-start gap-3 text-gray-200 font-medium drop-shadow-sm">
          ...
          >
            ...
            <ul className="space-y-4">
              {siteConfig.company.licenses.map((item, index) => (
                <li key={index} className="flex items-center gap-3 text-gray-200 font-medium p-3 rounded-lg bg-white/5 border border-white/5 hover:border-[#00B4D8]/30 hover:bg-[#00B4D8]/10 transition-colors shadow-sm">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-2xl bg-black/40 border border-white/10 backdrop-blur-md hover:border-[#00B4D8]/50 transition-colors shadow-lg">
              ...
              <p className="text-gray-200 text-sm px-4 font-medium leading-relaxed">{siteConfig.company.address}</p>
            ...
            <div className="text-center p-6 rounded-2xl bg-black/40 border border-white/10 backdrop-blur-md hover:border-[#00B4D8]/50 transition-colors shadow-lg">
              ...
              <p className="text-gray-200 text-sm font-medium">{siteConfig.company.phone}</p>
            </div>
            ...
            <div className="text-center p-6 rounded-2xl bg-black/40 border border-white/10 backdrop-blur-md hover:border-[#00B4D8]/50 transition-colors shadow-lg">
              ...
              <p className="text-gray-200 text-sm font-medium">{siteConfig.company.email}</p>
            </div>
          </div>
        </motion.div>

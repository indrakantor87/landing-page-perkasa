  ...
  return (
    <section className="py-20 bg-[#0B0F19] relative overflow-hidden border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 text-center">
        <h2 className="text-3xl font-bold text-white mb-4">Kata Mereka Tentang <span className="text-perkasa-red">Perkasa</span></h2>
        <p className="text-gray-400">Bergabung dengan ribuan pelanggan yang telah merasakan kecepatan internet sesungguhnya.</p>
      </div>
      ...
      <div className="relative w-full overflow-hidden">
        ...
        >
          {[...siteConfig.testimonials, ...siteConfig.testimonials].map((item, i) => (
            <div 
              key={i} 
              className="w-[350px] p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm hover:border-perkasa-red/30 transition-colors"
            >
              <div className="flex items-start justify-between mb-4">
                ...
                <Quote size={20} className="text-perkasa-red/50" />
              </div>

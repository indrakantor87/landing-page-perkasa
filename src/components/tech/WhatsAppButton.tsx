    ...
    <AnimatePresence>
      {isVisible && (
        <motion.a
          ...
          whileTap={{ scale: 0.9 }}
          className="fixed bottom-8 right-4 z-50 p-4 bg-[#25D366] rounded-full shadow-2xl shadow-green-500/30 text-white flex items-center justify-center group cursor-pointer hover:shadow-green-500/50 transition-shadow"

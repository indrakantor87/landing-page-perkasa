  ...
  return (
    <footer id="contact" className="bg-black/20 backdrop-blur-md border-t border-white/10 relative z-10 pt-16 pb-0 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"> <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 lg:gap-x-16 gap-y-4 md:gap-y-1 text-sm text-white">
            <a href="https://wa.me/6281252000220" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:text-white transition-colors group whitespace-nowrap">
              <div className="p-2 rounded-full bg-white/10 group-hover:bg-green-500/20 transition-colors border border-white/20">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-green-400 drop-shadow-md">
              ...
              <span className="font-medium drop-shadow-md">081252000220</span>
            </a>
            ...
            <a href="https://instagram.com/perkasa_networks" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:text-white transition-colors group whitespace-nowrap">
              <div className="p-2 rounded-full bg-white/10 group-hover:bg-pink-500/20 transition-colors border border-white/20">
                <Instagram size={20} className="text-pink-400 drop-shadow-md" />
              </div>
              <span className="font-medium drop-shadow-md">perkasa_networks</span>
            </a>
            ...
            <a href="https://facebook.com/perkasa.networks" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:text-white transition-colors group whitespace-nowrap">
              <div className="p-2 rounded-full bg-white/10 group-hover:bg-blue-500/20 transition-colors border border-white/20">
                <Facebook size={20} className="text-blue-400 drop-shadow-md" />
              </div>
              <span className="font-medium drop-shadow-md">perkasa networks</span>
            </a>
            ...
            <a href="https://tiktok.com/@perkasa.networks" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:text-white transition-colors group whitespace-nowrap">
              <div className="p-2 rounded-full bg-white/10 group-hover:bg-white/20 transition-colors border border-white/20">
        ...
        {/* Copyright */}
        <div className="pt-4 pb-0 border-t border-white/5 text-center md:text-left flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-white font-medium">
